...
<html lang="en">
  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	       <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a href="contact.php" class="nav-link">Suggestion</a></li>
    ...
    <!-- END nav -->
      ...
      <div class="one-half img" style="background-image: url(images/wallpaper9.jpg);"></div>
      <div class="one-half ftco-animate">
        <div class="heading-section ftco-animate ">
          <h2 class="mb-4">Tell Us What's On Your Mind !</h2>
        </div>
        <div>
          <h2 class="h4">Suggestion Form</h2>
            <form action="contact_code.php" method="POST" class="contact-form" >
              <div class="row">
                <div class="col-md-6">
              ...
              <div class="form-group">
                <textarea type="text" name="pesan" cols="30" rows="7" class="form-control" placeholder="Give Us Your Suggestion"></textarea>
              </div>
