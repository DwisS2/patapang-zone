...
if($g_tipe == "image/jpeg" || $g_tipe == "image/png"){ // Cek apakah tipe file yang diupload adalah JPG / JPEG / PNG
	...
	if($g_ukuran <= 1000000){ // Cek apakah ukuran file yang diupload kurang dari sama dengan 1MB
		...
		if(move_uploaded_file($tmp_file, $path)){ // Cek apakah gambar berhasil diupload atau tidak
			...
			$query = "INSERT INTO game (g_nama, g_kategori, g_deskripsi1, g_deskripsi2, waktu, g_gambar, g_link, g_ukuran, g_tipe) VALUE ('$g_nama', '$g_kategori', '$g_deskripsi1', '$g_deskripsi2','$waktu', '$g_gambar', '$g_link', '$g_ukuran', '$g_tipe')";
