	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	       <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a href="trouble.php" class="nav-link">Trouble</a></li>
          </ul>
	      </div>
		  </div>
	  </nav>
...
<section class="ftco-about d-md-flex">
      <div class="one-half img" style="background-image: url(images/wallpaper10.jpg);"></div>
      <div class="one-half ftco-animate">
        <div class="heading-section ftco-animate ">
          <h2 class="mb-4">Tell Us What's Your Trouble !</h2>
        </div>
        <div>
          <h2 class="h4">Trouble Form</h2>
            <form action="trouble_code.php" method="POST" class="contact-form" >
              <div class="row">
                <div class="col-md-6">
              ...
              <div class="form-group">
                <input type="text" name="judul" class="form-control" placeholder="What's The Trouble ?">
              </div>

              <div class="form-group">
                <textarea type="text" name="pesan" cols="30" rows="7" class="form-control" placeholder="Describe your trouble"></textarea>
              </div>

              <div class="form-group">
                <input type="submit" value="Send Message" name="daftar" class="btn btn-primary py-3 px-5">
              </div>
            </form>
        </div>
      </div>
