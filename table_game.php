						...
						<tbody>
							<?php
								...
								while($game = mysqli_fetch_array($query)){
									...
									echo "<td >".$game['g_nama']."</td>";
									echo "<td >".$game['g_kategori']."</td>";

									// echo "<td >".$game['g_deskripsi1']."</td>";
									echo "<td>".substr($game['g_deskripsi1'],0,40)."...."."</td>";

									// echo "<td >".$game['g_deskripsi2']."</td>";
									echo "<td>".substr($game['g_deskripsi2'],0,40)."...."."</td>";
									
									echo "<td>".substr($game['g_link'],0,20)."...."."</td>";

									echo "<td>".$game['waktu']."</td>";

									// echo "<td >".$game['g_gambar']."</td>";
									echo "<td><img src='images/".$game['g_gambar']."' width='100' height='100'></td>";
									
									echo "<td>";
									echo "<a href='edit_game.php?g_id=".$game['g_id']."' class='btn btn-warning'>Edit</a>";

									echo "<a href='table_game_delete.php?g_id=".$game['g_id']."' class='btn btn-danger'>Delete</a>";
									echo "</td>";
